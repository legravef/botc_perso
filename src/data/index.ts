...
import { OVER_THE_RIVER_CHARACTERS } from './characters/over-the-river'
...
export { OVER_THE_RIVER_CHARACTERS } from './characters/over-the-river'
...
export const CHARACTERS_BY_SCRIPT: Record<ScriptId, Character[]> = {
  ...
  'over-the-river': OVER_THE_RIVER_CHARACTERS,
}
