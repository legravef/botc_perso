...
export const BAD_MOON_RISING_CHARACTERS: Character[] = [
  character({ id: 'grandmother', nameFr: 'Grand-mère', nameEn: 'Grandmother', category: 'townsfolk', description: 'La première nuit, vous voyez 1 joueur gentil et son rôle. Si le Démon le tue, vous mourrez aussi.', first: 16, frequency: 'first-night-only', setup: true, reminders: ['Petit-fils'] }),
  character({ id: 'sailor', nameFr: 'Marin', nameEn: 'Sailor', category: 'townsfolk', description: 'Chaque nuit, choisissez un joueur en vie : lui ou vous serez ivre cette nuit. Vous êtes immortel si vous êtes celui resté sobre.', first: 3, other: 2, frequency: 'each-night', selection: 'single-player', targets: 1, reminders: ['Ivre'] }),
  character({ id: 'chambermaid', nameFr: 'Concierge', nameEn: 'Chambermaid', category: 'townsfolk', description: 'Chaque nuit, choisissez 2 joueurs en vie autre que vous. Vous apprenez combien se sont réveillés cette nuit grâce à leur pouvoir.', first: 17, other: 20, frequency: 'each-night', selection: 'two-players', targets: 2 }),
  character({ id: 'exorcist', nameFr: 'Exorciste', nameEn: 'Exorcist', category: 'townsfolk', description: 'Chaque nuit*, choisissez 1 joueur (différent de la nuit précédente) : si c’est le Démon, il saura qui vous êtes mais ne pourra pas utiliser son pouvoir cette nuit.', other: 8, frequency: 'each-night-except-first', selection: 'single-player', targets: 1, reminders: ['Exorcisé'] }),
  ...
  character({ id: 'courtier', nameFr: 'Courtisane', nameEn: 'Courtier', category: 'townsfolk', description: 'Une fois pendant la partie, la nuit, choisissez un rôle. S’il est en jeu, il sera ivre pendant 3 jours et 3 nuits.', first: 4, other: 4, frequency: 'once-per-game', selection: 'none', reminders: ['Ivre x3'] }),
  ...
  character({ id: 'goon', nameFr: 'Bras droit', nameEn: 'Goon', category: 'outsider', description: 'Chaque nuit, le 1er joueur qui vous cible grâce à son pouvoir est ivre jusqu’à la prochaine nuit. Votre alignement s’aligne au sien (gentil/méchant).', first: 2, other: 19, frequency: 'each-night', reminders: ['A changé d’équipe'] }),
  ...
  character({ id: 'godfather', nameFr: 'Parrain', nameEn: 'Godfather', category: 'minion', description: 'La première nuit, vous savez quels parias sont en jeu. Si l’un d’eux meurt en journée, la nuit d’après, tuez quelqu’un [+1 ou -1 parias].', first: 5, other: 14, frequency: 'each-night', selection: 'single-player', targets: 1, setup: true, setupModifier: { type: 'choose-outsider-delta', choices: [-1, 1] }, reminders: ['A tué'] }),
  character({ id: 'devils-advocate', nameFr: 'Avocat du diable', nameEn: "Devil's Advocate", category: 'minion', description: 'Chaque nuit, choisissez un joueur en vie (différent de la nuit précédente). Si exécuté le lendemain, ce joueur ne meurt pas.', first: 6, other: 6, frequency: 'each-night', selection: 'single-player', targets: 1, reminders: ['Protégé'] }),
  ...
  character({ id: 'pukka', nameFr: 'Pukka', nameEn: 'Pukka', category: 'demon', description: 'Chaque nuit, choisissez un joueur. Il est empoisonné, puis meurt la nuit suivante (et n’est plus empoisonné).', first: 10, other: 10, frequency: 'each-night', selection: 'single-player', targets: 1, setup: true, reminders: ['Empoisonné'] }),
