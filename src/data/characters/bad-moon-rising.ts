...
export const BAD_MOON_RISING_CHARACTERS: Character[] = [
  ...
  character({ id: 'chambermaid', nameFr: 'Concierge', nameEn: 'Chambermaid', category: 'townsfolk', description: 'Chaque nuit, choisissez 2 joueurs en vie autre que vous. Vous apprenez combien se sont réveillés cette nuit grâce à leur pouvoir.', other: 3, frequency: 'each-night-except-first', selection: 'two-players', targets: 2 }),
  character({ id: 'exorcist', nameFr: 'Exorciste', nameEn: 'Exorcist', category: 'townsfolk', description: 'Chaque nuit* (différent de la nuit précédente), choisissez 1 joueur : si c’est le Démon, il saura qui vous êtes mais ne pourra pas utiliser son pouvoir cette nuit.', other: 4, frequency: 'each-night-except-first', selection: 'single-player', targets: 1, reminders: ['Exorcisé'] }),
  character({ id: 'innkeeper', nameFr: 'Aubergiste', nameEn: 'Innkeeper', category: 'townsfolk', description: 'Chaque nuit*, choisissez 2 joueurs : ils ne peuvent pas mourir cette nuit, mais l’un des 2 sera ivre cette nuit et le jour suivant.', other: 5, frequency: 'each-night-except-first', selection: 'two-players', targets: 2, reminders: ['Protégé', 'Ivre'] }),
  ...
  character({ id: 'courtier', nameFr: 'Courtisane', nameEn: 'Courtier', category: 'townsfolk', description: 'Une fois pendant la partie, la nuit, choisissez un rôle. S’il est en jeu, il sera ivre pendant 3 jours et 3 nuits.', other: 7, frequency: 'once-per-game', selection: 'none', reminders: ['Ivre x3'] }),
  character({ id: 'professor', nameFr: 'Professeur', nameEn: 'Professor', category: 'townsfolk', description: 'Une fois par partie, la nuit*, choisissez un mort. Il est ressuscité si c’est un villageois.', other: 8, frequency: 'once-per-game', selection: 'single-player', targets: 1, reminders: ['Ressuscité'] }),
  ...
  character({ id: 'goon', nameFr: 'Bras droit', nameEn: 'Goon', category: 'outsider', description: 'Chaque nuit, le 1er joueur qui vous cible grâce à son pouvoir est ivre jusqu’à la prochaine nuit. Votre alignement s’aligne au sien (gentil/méchant).', first: 9, other: 9, frequency: 'each-night', reminders: ['A changé d’équipe'] }),
  character({ id: 'lunatic', nameFr: 'Lunatique', nameEn: 'Lunatic', category: 'outsider', description: 'Vous pensez être le démon, mais vous ne l’êtes pas. Le démon sait qui vous êtes et qui vous tuez la nuit.', first: 10, other: 10, frequency: 'each-night', selection: 'two-players', targets: 2, setup: true, reminders: ['Lunatique'] }),
  ...
  character({ id: 'godfather', nameFr: 'Parrain', nameEn: 'Godfather', category: 'minion', description: 'La première nuit, vous savez quels parias sont en jeu. Si l’un d’eux meurt en journée, la nuit d’après, tuez quelqu’un [+1 ou -1 parias].', first: 11, other: 11, frequency: 'each-night', selection: 'single-player', targets: 1, setup: true, setupModifier: { type: 'choose-outsider-delta', choices: [-1, 1] }, reminders: ['A tué'] }),
  character({ id: 'devils-advocate', nameFr: 'Avocat du diable', nameEn: "Devil's Advocate", category: 'minion', description: 'Chaque nuit, choisissez un joueur en vie (différent de la nuit précédente). Si exécuté le lendemain, ce joueur ne meurt pas.', other: 12, frequency: 'each-night-except-first', selection: 'single-player', targets: 1, reminders: ['Protégé'] }),
  ...
  character({ id: 'zombuul', nameFr: 'Zombuul', nameEn: 'Zombuul', category: 'demon', description: 'Chaque nuit*, si personne n’est mort pendant la journée, tuez quelqu’un. La première fois que vous mourrez, vous apparaissez comme mort mais restez en vie.', other: 14, frequency: 'each-night-except-first', selection: 'single-player', targets: 1, setup: true, reminders: ['Mort vivant'] }),
  character({ id: 'pukka', nameFr: 'Pukka', nameEn: 'Pukka', category: 'demon', description: 'Chaque nuit, choisissez un joueur. Il est empoisonné, puis meurt la nuit suivante (et n’est plus empoisonné).', other: 15, frequency: 'each-night-except-first', selection: 'single-player', targets: 1, setup: true, reminders: ['Empoisonné'] }),
  character({ id: 'shabaloth', nameFr: 'Shabaloth', nameEn: 'Shabaloth', category: 'demon', description: 'Chaque nuit*, choisissez 2 joueurs : ils meurent. L’une de vos victimes de la nuit précédente peut être « régurgitée » : elle ressuscite.', other: 16, frequency: 'each-night-except-first', selection: 'two-players', targets: 2, setup: true, reminders: ['A tué'] }),
  character({ id: 'po', nameFr: 'Po', nameEn: 'Po', category: 'demon', description: 'Chaque nuit*, vous pouvez choisir un joueur : il meurt. Si la nuit précédente vous n’avez choisi personne, vous êtes obligé de tuer 3 joueurs cette nuit-là.', other: 17, frequency: 'each-night-except-first', selection: 'single-player', targets: 1, setup: true, reminders: ['A chargé'] }),
]
